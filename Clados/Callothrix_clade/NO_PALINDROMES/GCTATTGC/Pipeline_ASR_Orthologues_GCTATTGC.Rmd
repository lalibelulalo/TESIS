---
title: "Reconstrucción Ancestral de Secuencias - GCTATTGC - PCC_7716"
author: "Eduardo PM"
date: "2023-03-30"
...
#setwd("/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC")
knitr::opts_knit$set(root.dir = "/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC")
```
...
```{r}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC
#setwd("/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC")
...
Aqui podemos ver que  **PCC_7716** es la que tiene mas sitios (**222**) seguido de **NIES-4071** y **NIES-4105** con **195**.


```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC
awk '{if ($5>=1 && $2=="Calothrix_sp_PCC_7716"){print $1}}' ../../Markov_count_GCTATTGC_2023-5-8_13hrs20mins_Octanuc_.txt >Ortologos_GCTATTGC_Calothrix_sp_PCC_7716.txt
```

**Ortologos_GCTATTGC_Calothrix_sp_NIES-4071.txt** contiene 115 ortólogos los cuales estan presentes en las 6 especies y tienen por lo menos una ocurrencia del palindromo **GCTATTGC**
```{bash, eval = FALSE}
###
5358_OmpA_family_protein.fna
5362_trpA.fna
5404_ftsH3.fna
5432_PspA-IM30_family_pro...fna
5433_PspA-IM30_family_pro...fna
5445_trifunctional_serine...fna
5445_trifunctional_serine...fna
5445_trifunctional_serine...fna
5449_nadB.fna
5466_SpoIID-LytB_domain-c...fna
###
```
...
```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC
mkdir Orthologues_GCTATTGC_PCC_7716  ## Creo Carpeta
cd ../../gbff_homologues/CalothrixspNIES-3974NIES-3974_f0_0taxa_algOMCL_e0_ ## Entro a la carpeta de homólogos
for word in $(cat ../../NO_PALINDROMES/GCTATTGC/Ortologos_GCTATTGC_Calothrix_sp_PCC_7716.txt); do cp $word ../../NO_PALINDROMES/GCTATTGC/Orthologues_GCTATTGC_PCC_7716; done ## copio los ortólogos de la lista a la carpeta
```
## Filtrado de paralogos
voy a crear dos carpetas una que contenga archivos con paralogos y otra que solo tenga ortólogos
```{bash, eval = FALSE}
cd ../../NO_PALINDROMES/GCTATTGC/
...
```
```{python, eval = FALSE}
python3 ../../FiltradoParalogos.py Orthologues_GCTATTGC_PCC_7716/
```

Esto me dio como resultado 149 archivos sin paralogos y 43 archivos con paralogos los cuals omitiré por ahora.

Ahora edito el archivo fasta para que el encabezado incluya unicamente la especie
```{bash, eval = FALSE}
# /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCTATTGC/Only_ORTHOLOGUES
cd Only_ORTHOLOGUES/
...
```{python, eval = FALSE}
python3 ../../AlignmentPalindromeCoords.py Only_ORTHOLOGUES/ GCTATTGC PCC_7716
```
...
###
FILE	PAL	START	END
8645_RnfABCDGE_type_elect...fna.awk1.mafft.phy	gctattgc	324	331
7196_ABC_transporter_subs...fna.awk1.mafft.phy	gctattgc	994	1001
9974_D-alanyl-D-alanine_c...fna.awk1.mafft.phy	gctattgc	1243	1250
8967_UDP-N-acetylmuramoyl...fna.awk1.mafft.phy	gctattgc	610	617
7821_pyrH.fna.awk1.mafft.phy	gctattgc	310	317
9356_ruvA.fna.awk1.mafft.phy	gctattgc	271	278
7745_sugar_phosphate_nucl...fna.awk1.mafft.phy	gctattgc	616	623
8091_NDP-sugar_synthase.fna.awk1.mafft.phy	gctattgc	1132	1139
8787_hypothetical_protein.fna.awk1.mafft.phy	gctattgc	246	253
... etc
###
```
