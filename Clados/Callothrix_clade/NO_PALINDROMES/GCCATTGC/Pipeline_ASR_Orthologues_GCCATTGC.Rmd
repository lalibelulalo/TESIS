---
title: "Reconstrucción Ancestral de Secuencias - GCCATTGC - PCC_7716"
author: "Eduardo PM"
date: "2023-03-30"
...
#setwd("/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC")
knitr::opts_knit$set(root.dir = "/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC")
```
...
```{r}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC
#setwd("/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC")
...
Aqui podemos ver que  **PCC_7716** es la que tiene mas sitios (**116**) seguido de **NIES-4071** y **NIES-4105** con **101**.


```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC
awk '{if ($5>=1 && $2=="Calothrix_sp_PCC_7716"){print $1}}' ../../Markov_count_GCCATTGC_2023-5-8_13hrs20mins_Octanuc_.txt >Ortologos_GCCATTGC_Calothrix_sp_PCC_7716.txt
```

**Ortologos_GCCATTGC_Calothrix_sp_NIES-4071.txt** contiene 115 ortólogos los cuales estan presentes en las 6 especies y tienen por lo menos una ocurrencia del palindromo **GCCATTGC**
```{bash, eval = FALSE}
###
5352_secA.fna
5354_sat.fna
...
```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC
mkdir Orthologues_GCCATTGC_PCC_7716  ## Creo Carpeta
cd ../../gbff_homologues/CalothrixspNIES-3974NIES-3974_f0_0taxa_algOMCL_e0_ ## Entro a la carpeta de homólogos
for word in $(cat ../../NO_PALINDROMES/GCCATTGC/Ortologos_GCCATTGC_Calothrix_sp_PCC_7716.txt); do cp $word ../../NO_PALINDROMES/GCCATTGC/Orthologues_GCCATTGC_PCC_7716; done ## copio los ortólogos de la lista a la carpeta
```
## Filtrado de paralogos
voy a crear dos carpetas una que contenga archivos con paralogos y otra que solo tenga ortólogos
```{bash, eval = FALSE}
cd ../../NO_PALINDROMES/GCCATTGC/
...
```
```{python, eval = FALSE}
python3 ../../FiltradoParalogos.py Orthologues_GCCATTGC_PCC_7716/
```
...
```{bash, eval = FALSE}
# /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/NO_PALINDROMES/GCCATTGC/Only_ORTHOLOGUES
cd Only_ORTHOLOGUES/
...
```{python, eval = FALSE}
python3 ../../AlignmentPalindromeCoords.py Only_ORTHOLOGUES/ GCCATTGC PCC_7716
```
...
###
FILE	PAL	START	END
5539_NAD-P--FAD-dependent...fna.awk1.mafft.phy	gccattgc	57	64
7941_AI-2E_family_transpo...fna.awk1.mafft.phy	gccattgc	463	470
7389_shikimate_dehydrogen...fna.awk1.mafft.phy	gccattgc	82	89
7597_hypothetical_protein.fna.awk1.mafft.phy	gccattgc	6	13
8967_UDP-N-acetylmuramoyl...fna.awk1.mafft.phy	gccattgc	202	209
8151_lipA.fna.awk1.mafft.phy	gccattgc	529	536
6111_2-phosphosulfolactat...fna.awk1.mafft.phy	gccattgc	484	491
7728_tetratricopeptide_re...fna.awk1.mafft.phy	gccattgc	763	770
9749_hypothetical_protein.fna.awk1.mafft.phy	gccattgc	94	101
... etc
###
```
