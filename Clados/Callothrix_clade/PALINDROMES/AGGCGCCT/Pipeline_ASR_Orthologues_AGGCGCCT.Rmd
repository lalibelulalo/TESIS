---
title: "Reconstrucción Ancestral de Secuencias - AGGCGCCGT - NIES-4071"
author: "Eduardo PM"
date: "2023-03-30"
...
#setwd("/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/")
knitr::opts_knit$set(root.dir = "/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/")
```
...
```{r}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/
#setwd("/home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/")
Counts <- read.table("../../Markov_count_AGGCGCCT_2023-5-7_18hrs43mins_Octanuc_.txt", sep = "\t", header = TRUE)
...
Aqui podemos ver que  **NIES-4071** y **NIES-4105** son las que tienen mayores sitios (**442**) seguido de **Calothrix_sp_PCC_7716** con **571**.


```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/
awk '{if ($5>=1 && $2=="Calothrix_sp_NIES-4071"){print $1}}' ../../Markov_count_AGGCGCCT_2023-5-7_18hrs43mins_Octanuc_.txt >Ortologos_AGGCGCCT_Calothrix_sp_NIES-4071.txt
```

**Ortologos_AGGCGCCT_Calothrix_sp_NIES-4071.txt** contiene 368 ortólogos los cuales estan presentes en las 6 especies y tienen por lo menos una ocurrencia del palindromo **AGGCGCCT**
```{bash, eval = FALSE}
###
...
5358_OmpA_family_protein.fna
5366_YbhN_family_protein.fna
5367_larC.fna
5372_DNA_adenine_methylas...fna
...
```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/
mkdir Orthologues_AGGCGCCT_NIES-4071  ## Creo Carpeta
cd ../../gbff_homologues/CalothrixspNIES-3974NIES-3974_f0_0taxa_algOMCL_e0_ ## Entro a la carpeta de homólogos
for word in $(cat ../../PALINDROMES/AGGCGCCT/Ortologos_AGGCGCCT_Calothrix_sp_NIES-4071.txt); do cp $word ../../PALINDROMES/AGGCGCCT/Orthologues_AGGCGCCT_NIES-4071; done ## copio los ortólogos de la lista a la carpeta
```
## Filtrado de paralogos
voy a crear dos carpetas una que contenga archivos con paralogos y otra que solo tenga ortólogos
```{bash, eval = FALSE}
cd ../../PALINDROMES/AGGCGCCT/
...
```
```{python, eval = FALSE}
python3 ../../FiltradoParalogos.py Orthologues_AGGCGCCT_NIES-4071/
```
...
```{bash, eval = FALSE}
## /home/lalibelulalo/PIPELINES_2023/ASR_ORTHOLOGUES/Callothrix_clade/PALINDROMES/AGGCGCCT/Only_ORTHOLOGUES/
cd Only_ORTHOLOGUES
...
```
```{python, eval = FALSE}
python3 ../../AlignmentPalindromeCoords.py Only_ORTHOLOGUES/ AGGCGCCT NIES-4071
```
...
###
FILE	PAL	START	END
6349_serine_hydrolase.fna.awk1.mafft.phy	aggcgcct	1788	1795
8645_RnfABCDGE_type_elect...fna.awk1.mafft.phy	aggcgcct	695	702
5720_ABC_transporter_perm...fna.awk1.mafft.phy	aggcgcct	1068	1075
9977_metG.fna.awk1.mafft.phy	aggcgcct	1310	1317
6097_M61_family_metallope...fna.awk1.mafft.phy	aggcgcct	512	519
6097_M61_family_metallope...fna.awk1.mafft.phy	aggcgcct	1827	1834
8113_dapF.fna.awk1.mafft.phy	aggcgcct	678	685
7998_HAD_family_hydrolase.fna.awk1.mafft.phy	aggcgcct	255	262
8169_devC.fna.awk1.mafft.phy	aggcgcct	600	607
... etc
###
```
