...
```{r TABMuts,  eval=knitr::is_html_output(), echo=FALSE, message=FALSE,warning=FALSE}
library(kableExtra)
library(formattable)
...
```{r FIG18C, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG19C, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG20C, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio HIP1.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Cyanobacterium_clade/PALINDROMES/GCGATCGC/PCC_8801/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
```{r FIG21C, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio HIP para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
```{r FIG22C, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios HIP para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
```{r FIG23C, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio HIP1.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
```{r FIG18G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG19G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG20G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio HIP1.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Geminocystis_clade/PALINDROMES/GCGATCGC/NIES-4102/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
```{r FIG21G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio HIP para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
```{r FIG22G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios HIP para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
```{r FIG23G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio HIP1.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,results='hide'}
source("ASR_Orth_Functions/NodeAndEdges.R")
Transition_table <- read.table("Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/TRANSICIONES.txt", sep = "\t", header = TRUE )
Network <- Create_Network(Transitions = Transition_table)
```
...
```{r FIG24G, eval=knitr::is_html_output(), echo=FALSE,fig.align='center',fig.cap="**Red de todas las transiciones del clado Geminocystis.** En esta imagen se muestra una red en la que cada nodo es un octanucleótido el cual esta unido a otro nodo por un vertice. Dicho vertice tiene un grosor proporcional al numero de veces que dicha transición ocurrió en la reconstrucción ancestral de sitios.",message=FALSE,warning=FALSE}
Sys.setenv("OPENSSL_CONF"="/dev/null")
#RED
FORCE
```
...
```{r FIG25G, eval=knitr::is_html_output(), echo=FALSE, fig.align='center',fig.cap="**Red de todas las transiciones del clado Geminocystis.** En esta imagen se muestra la red  de la Figura \\@ref(fig:FIG24G) de una forma mas visual y con el numero de veces que ocurrio cada transición, asi como la dirección en la que ocurrió.",message=FALSE,warning=FALSE}
Sys.setenv("OPENSSL_CONF"="/dev/null")
## Este ultimo grafo muestra el grafo anterior pero de una forma mas analizable.
networkD3::sankeyNetwork(Links = edges_d3, Nodes = nodes_d3, Source = "from", Target = "to", 
                         NodeID = "label", Value = "weight", fontSize = 16, unit = "TIME(s)")
...
```{r TAB62G,  eval=knitr::is_html_output(), echo=FALSE, message=FALSE,warning=FALSE}
library(kableExtra)
library(formattable)
Sys.setenv("OPENSSL_CONF"="/dev/null")
table.Transitions <- as.data.frame(edges)
...
row.names(table.Transitions ) <- NULL
table.Transitions$from = cell_spec(table.Transitions$from,
                                   color = ifelse(table.Transitions$from == 'TCGATCGA',
                                                  "red",
                                                  ifelse(table.Transitions$from == 'GCGATCGC',
                                                         "orange",
                                                         ifelse(table.Transitions$from == 'GCAATTGC',
                                                         "blue",
                                                         "black"))))
table.Transitions$to= cell_spec(table.Transitions$to,
                                   color = ifelse(table.Transitions$to == 'TCGATCGA',
                                                  "red",
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,results='hide'}
Directed_Transition_table <- read.table("Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/TRANSICIONES_DIRECCION.txt", sep = "\t", header = TRUE )
Directed_Network <- Create_Directed_Network(DirectedTransitions = Directed_Transition_table,
                                             Direction = "18--17",
                                             Weight = 28)
nodesL = Directed_Network[[1]]
...
```{r FIG26G, eval=knitr::is_html_output(), echo=FALSE,fig.align='center',fig.cap="**Red de las transiciones entre los Nodos 18 y 19 del clado Geminocystis.** En esta imagen se muestra una red en la que cada nodo es un octanucleótido el cual esta unido a otro nodo por un vertice. Dicho vertice tiene un grosor proporcional al numero de veces que dicha transición ocurrió en la reconstrucción ancestral de sitios.",message=FALSE,warning=FALSE}
Sys.setenv("OPENSSL_CONF"="/dev/null")
networkD3::forceNetwork(Links = edges_d3L, Nodes = nodes_d3L,
                        Source = "from", Target = "to", 
                        NodeID = "label", Group = "id", Value = "weight", 
...
```{r FIG28G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
File= "Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/Orthologues_Palindrome_sites.AllFrames.SECOND.txt"
table = read.table(File,header = TRUE,sep = "\t",row.names = NULL)
tableMA = table[ , c(2,5,8)]
tableMA = as.data.frame(tableMA)
...
```{r FIG29G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
FileRF1 = "Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Extraigo unicamente la columna de especie (Spp) y SType:
tableM1.SType = tableRF1[ , c(2,20)]
##Cuento los tipos de sustitución para cada Nodo:
...
FileRF2 = "Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/codon_mutations_RF2.rooted.txt"
tableRF2 = read.table(FileRF2,header = TRUE,sep = "\t",row.names = NULL)
tableM2.SType = tableRF2[ , c(2,20)]
tableM2.SType <- data.table::setDT(tableM2.SType)[,list(Counts=as.numeric(.N)),names(tableM2.SType)]

FileRF3 = "Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/codon_mutations_RF3.rooted.txt"
tableRF3 = read.table(FileRF3,header = TRUE,sep = "\t",row.names = NULL)
tableM3.SType = tableRF3[ , c(2,22)]
tableM3.SType <- data.table::setDT(tableM3.SType)[,list(Counts=as.numeric(.N)),names(tableM3.SType)]
...
ggplot2::ggplot(tableM3.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ...
  ggplot2::ggtitle("Marco de lectura 3") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 2.5)
...
```{r FIG30G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio TCGATCGA.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
ggplot2::ggplot(tableM1.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 1 - Nodos con TCGATCGA en el nodo parental") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM2.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 2 - Nodos con TCGATCGA en el nodo parental") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM3.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 3 - Nodos con TCGATCGA en el nodo parental") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```

```{r FIG31G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio TCGATCGA para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
ggplot2::ggplot(df, ggplot2::aes(x = reorder(Nodo, -Count), y = Count, fill = NucPos)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set2")+
  ggplot2::ggtitle("Marco de lectura 1 - Nodos con TCGATCGA en el nodo parental - Mutaciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Position")+
  ggplot2::geom_text(ggplot2::aes(label = Count, group = NucPos), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(dfB, ggplot2::aes(x = reorder(Nodo, -Count), y = Count, fill = NucPos)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set2")+
  ggplot2::ggtitle("Marco de lectura 2 - Nodos con TCGATCGA en el nodo parental - Mutaciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Position")+
  ggplot2::geom_text(ggplot2::aes(label = Count, group = NucPos), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(dfC, ggplot2::aes(x = reorder(Nodo, -Count), y = Count, fill = NucPos)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set2")+
  ggplot2::ggtitle("Marco de lectura 3 - Nodos con TCGATCGA en el nodo parental - Mutaciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Position")+
  ggplot2::geom_text(ggplot2::aes(label = Count, group = NucPos), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```

```{r FIG32G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios TCGATCGA para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
ggplot2::ggplot(df2.SMType, ggplot2::aes(x = reorder(Nodo, -Counts), y = Counts, fill = SMType)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set3")+
  ggplot2::ggtitle("Marco de lectura 1 - Nodos con TCGATCGA en el nodo parental - Tipo de sustituciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SMType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(df2B.SMType, ggplot2::aes(x = reorder(Nodo, -Counts), y = Counts, fill = SMType)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set3")+
  ggplot2::ggtitle("Marco de lectura 2 - Nodos con TCGATCGA en el nodo parental - Tipo de transiciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SMType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(df2C.SMType, ggplot2::aes(x = reorder(Nodo, -Counts), y = Counts, fill = SMType)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set3")+
  ggplot2::ggtitle("Marco de lectura 3 - Nodos con TCGATCGA en el nodo parental - Tipo de transiciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SMType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```
...
```{r FIG33G, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio TCGATCGA.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
ggplot2::ggplot(tableM1.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 1 - TCGATCGA Solo en el nodo actual y no en el parental.") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM2.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 2 - TCGATCGA Solo en el nodo actual y no en el parental.") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM3.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 3 - TCGATCGA Solo en el nodo actual y no en el parental.") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```
...
```{r FIG18P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG19P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG20P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio HIP1.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Pseudoanabaena_clade/PALINDROMES/GCGATCGC/PCC_7336/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
```{r FIG21P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio HIP para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
```{r FIG22P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios HIP para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
```{r FIG23P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio HIP1.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
```{r,echo=FALSE,message=FALSE,warning=FALSE,results='hide'}
source("ASR_Orth_Functions/NodeAndEdges.R")
Transition_table <- read.table("Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/TRANSICIONES.txt", sep = "\t", header = TRUE )
Network <- Create_Network(Transitions = Transition_table)
```
...
```{r FIG24P, eval=knitr::is_html_output(), echo=FALSE,fig.align='center',fig.cap="**Red de todas las transiciones del clado Pseudoanabaena.** En esta imagen se muestra una red en la que cada nodo es un octanucleótido el cual esta unido a otro nodo por un vertice. Dicho vertice tiene un grosor proporcional al numero de veces que dicha transición ocurrió en la reconstrucción ancestral de sitios.",message=FALSE,warning=FALSE}
Sys.setenv("OPENSSL_CONF"="/dev/null")
#RED
FORCE
```
...
```{r FIG25P, eval=knitr::is_html_output(), echo=FALSE, fig.align='center',fig.cap="**Red de todas las transiciones del clado Pseudoanabaena.** En esta imagen se muestra la red  de la Figura \\@ref(fig:FIG24P) de una forma mas visual y con el numero de veces que ocurrio cada transición, asi como la dirección en la que ocurrió.",message=FALSE,warning=FALSE}
Sys.setenv("OPENSSL_CONF"="/dev/null")
## Este ultimo grafo muestra el grafo anterior pero de una forma mas analizable.
networkD3::sankeyNetwork(Links = edges_d3, Nodes = nodes_d3, Source = "from", Target = "to", 
                         NodeID = "label", Value = "weight", fontSize = 16, unit = "TIME(s)")
...
```{r TAB62P,  eval=knitr::is_html_output(), echo=FALSE, message=FALSE,warning=FALSE}
library(kableExtra)
library(formattable)
Sys.setenv("OPENSSL_CONF"="/dev/null")
table.Transitions <- as.data.frame(edges)
...
row.names(table.Transitions ) <- NULL
table.Transitions$from = cell_spec(table.Transitions$from,
                                   color = ifelse(table.Transitions$from == 'GGGATCCC',
                                                  "red",
                                                  ifelse(table.Transitions$from == 'GCGATCGC',
                                                         "orange",
                                                         ifelse(table.Transitions$from == 'GCAATTGC',
                                                         ...
                                                         "black"))))
table.Transitions$to= cell_spec(table.Transitions$to,
                                   color = ifelse(table.Transitions$to == 'GGGATCCC',
                                                  "red",
                                                  ifelse(table.Transitions$to == 'GCGATCGC',
                                                         "orange",
                                                         ifelse(table.Transitions$from == 'GCAATTGC',
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,results='hide'}
Directed_Transition_table <- read.table("Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/TRANSICIONES_DIRECCION.txt", sep = "\t", header = TRUE )
Directed_Network <- Create_Directed_Network(DirectedTransitions = Directed_Transition_table,
                                             Direction = "JA-2-3Ba--7",
                                             Weight = 17)
nodesL = Directed_Network[[1]]
...
```{r FIG26P, eval=knitr::is_html_output(), echo=FALSE,fig.align='center',fig.cap="**Red de las transiciones entre los Nodos 7 y 8 del clado Pseudoanabaena.** En esta imagen se muestra una red en la que cada nodo es un octanucleótido el cual esta unido a otro nodo por un vertice. Dicho vertice tiene un grosor proporcional al numero de veces que dicha transición ocurrió en la reconstrucción ancestral de sitios.",message=FALSE,warning=FALSE}
Sys.setenv("OPENSSL_CONF"="/dev/null")
networkD3::forceNetwork(Links = edges_d3L, Nodes = nodes_d3L,
                        Source = "from", Target = "to", 
                        NodeID = "label", Group = "id", Value = "weight", 
...
```{r FIG28P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
File= "Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/Orthologues_Palindrome_sites.AllFrames.SECOND.txt"
table = read.table(File,header = TRUE,sep = "\t",row.names = NULL)
tableMA = table[ , c(2,5,8)]
tableMA = as.data.frame(tableMA)
...
```{r FIG29P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
FileRF1 = "Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Extraigo unicamente la columna de especie (Spp) y SType:
tableM1.SType = tableRF1[ , c(2,20)]
##Cuento los tipos de sustitución para cada Nodo:
...
FileRF2 = "Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/codon_mutations_RF2.rooted.txt"
tableRF2 = read.table(FileRF2,header = TRUE,sep = "\t",row.names = NULL)
tableM2.SType = tableRF2[ , c(2,20)]
tableM2.SType <- data.table::setDT(tableM2.SType)[,list(Counts=as.numeric(.N)),names(tableM2.SType)]

FileRF3 = "Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/codon_mutations_RF3.rooted.txt"
tableRF3 = read.table(FileRF3,header = TRUE,sep = "\t",row.names = NULL)
tableM3.SType = tableRF3[ , c(2,22)]
tableM3.SType <- data.table::setDT(tableM3.SType)[,list(Counts=as.numeric(.N)),names(tableM3.SType)]
...
```{r FIG30P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio GGGATCCC.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
ggplot2::ggplot(tableM1.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 1 - Nodos con GGGATCCC en el nodo parental") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM2.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 2 - Nodos con GGGATCCC en el nodo parental") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM3.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 3 - Nodos con GGGATCCC en el nodo parental") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```

```{r FIG31P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio GGGATCCC para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
ggplot2::ggplot(df, ggplot2::aes(x = reorder(Nodo, -Count), y = Count, fill = NucPos)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set2")+
  ggplot2::ggtitle("Marco de lectura 1 - Nodos con GGGATCCC en el nodo parental - Mutaciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Position")+
  ggplot2::geom_text(ggplot2::aes(label = Count, group = NucPos), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(dfB, ggplot2::aes(x = reorder(Nodo, -Count), y = Count, fill = NucPos)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set2")+
  ggplot2::ggtitle("Marco de lectura 2 - Nodos con GGGATCCC en el nodo parental - Mutaciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Position")+
  ggplot2::geom_text(ggplot2::aes(label = Count, group = NucPos), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(dfC, ggplot2::aes(x = reorder(Nodo, -Count), y = Count, fill = NucPos)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set2")+
  ggplot2::ggtitle("Marco de lectura 3 - Nodos con GGGATCCC en el nodo parental - Mutaciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Position")+
  ggplot2::geom_text(ggplot2::aes(label = Count, group = NucPos), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```

```{r FIG32P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios GGGATCCC para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
ggplot2::ggplot(df2.SMType, ggplot2::aes(x = reorder(Nodo, -Counts), y = Counts, fill = SMType)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set3")+
  ggplot2::ggtitle("Marco de lectura 1 - Nodos con GGGATCCC en el nodo parental - Tipo de sustituciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
...
ggplot2::ggplot(df2B.SMType, ggplot2::aes(x = reorder(Nodo, -Counts), y = Counts, fill = SMType)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set3")+
  ggplot2::ggtitle("Marco de lectura 2 - Nodos con GGGATCCC en el nodo parental - Tipo de transiciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SMType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 2.5)
...
ggplot2::ggplot(df2C.SMType, ggplot2::aes(x = reorder(Nodo, -Counts), y = Counts, fill = SMType)) + 
  ...
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::scale_fill_brewer(palette="Set3")+
  ggplot2::ggtitle("Marco de lectura 3 - Nodos con GGGATCCC en el nodo parental - Tipo de transiciones por nucleotido") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SMType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 2.5)
```
...
```{r FIG33P, echo=FALSE, fig.show="hold", out.width="110%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio GGGATCCC.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
ggplot2::ggplot(tableM1.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 1 - GGGATCCC Solo en el nodo actual y no en el parental.") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM2.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 2 - GGGATCCC Solo en el nodo actual y no en el parental.") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
...
ggplot2::ggplot(tableM3.SType, ggplot2::aes(x = reorder(Spp, -Counts), y = Counts, fill = SType)) + 
  ggplot2::geom_bar(position="dodge",stat = "identity") +
  ggplot2::theme(axis.text.x = ggplot2::element_text(angle = 45, vjust = 1.0, hjust=1))+
  ggplot2::ggtitle("Marco de lectura 3 - GGGATCCC Solo en el nodo actual y no en el parental.") +
  ggplot2::xlab("Nodo") + ggplot2::ylab("Conteo") + ggplot2::labs(fill = "Substitution Type")+
  ggplot2::geom_text(ggplot2::aes(label = Counts, group = SType), position = ggplot2::position_dodge(0.9), vjust = -0.3, size = 3.5)
```
