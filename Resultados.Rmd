...
```{r FIG28G, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG29G, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG30G, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio TCGATCGA.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Geminocystis_clade/PALINDROMES/TCGATCGA/PCC_6308/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
```{r FIG31G, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio TCGATCGA para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
```{r FIG32G, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios TCGATCGA para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
```{r FIG33G, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio TCGATCGA.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
```{r FIG28P, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG29P, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG30P, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio GGGATCCC.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Pseudoanabaena_clade/PALINDROMES/GGGATCCC/JA-2-3Ba/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
```{r FIG31P, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio GGGATCCC para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
```{r FIG32P, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios GGGATCCC para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
```{r FIG33P, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio GGGATCCC.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
...
```{r FIG28T, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia de peptidos por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG29T, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
...
```{r FIG30T, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo ancestral era un sitio CAGGCCTG.**",message=FALSE,warning=FALSE,results='hide'}
##Cargo la tabla
FileRF1 = "Clados/Thermosynechococcus_clade/PALINDROMES/CAGGCCTG/PCC_6312/codon_mutations_RF1.rooted.txt"
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
##Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
...
```{r FIG31T, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Frecuencia de las mutaciones de cada nucleótido del sitio CAGGCCTG para cada nodo segun el marco de lectura.**.",message=FALSE,warning=FALSE,results='hide'}
##Quito los casos que tengan deleciones
tableRF1<-tableRF1%>%
  filter(SType!='Deletion')
##Extraigo los nombres de los nodos
...
```{r FIG32T, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Frecuencia del tipo de sustituciónes de base en los sitios CAGGCCTG para cada marco de lectura**.",message=FALSE,warning=FALSE,results='hide'}
TR <- tableRF1[ , c(2,33,34,35,36,37,38,39,40)]
Spps <-unique(tableRF1[ , c(2)])
df2 = c()
for (i in 1:length(Spps)){
...
```{r FIG33T, echo=FALSE, fig.show="hold", out.width="50%",fig.align='center',fig.cap="**Abundancia del tipo de sustitución por cada nodo segun el marco de lectura. Unicamente para transiciones en los que el nodo actual era un sitio CAGGCCTG.**.",message=FALSE,warning=FALSE,results='hide'}
## Filtro dejando solo aquellos casos en los que HIP fue el palíndromo parental
tableRF1 = read.table(FileRF1,header = TRUE,sep = "\t",row.names = NULL)
tableRF1<-tableRF1%>%
  filter(ActualType=='SITE')
