...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\FunctionTok{normalizePath}\NormalTok{(}\StringTok{\textquotesingle{}figures/df\_refseq\_chr\_269\_Octanuc\_FrecObs\_sel32\_significative{-}palindromes.png\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\caption{Here is a nice figure!}\label{fig:FIG1}
\end{figure}
